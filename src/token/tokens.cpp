...
std::ostream &operator<<(std::ostream &os, const TokenType type) {
    switch (type) {
        ...
        case TokenType::T_MUT:
            os << "T_MUT";
            break;
        case TokenType::T_BINDFRT:
            os << "T_BINDFRT";
            break;
        case TokenType::T_DECORATE:
            os << "T_DECORATE";
            break;
        ...
        case TokenType::T_RPAREN:
            os << "T_RPAREN";
            break;
        case TokenType::T_LBLOCK:
            os << "T_LBLOCK";
            break;
        case TokenType::T_RBLOCK:
            os << "T_RBLOCK";
            break;
        ...
        case TokenType::T_ERROR:
            os << "\033[1;31mT_ERROR\033[0m";
            break;
        case TokenType::T_EOF:
            os << "T_EOF";
            break;
        case TokenType::T_FUNC_SIGN:
            os << "T_FUNC_SIGN";
            break;
        case TokenType::T_LFTYPE:
            os << "T_LFTYPE";
            break;
        case TokenType::T_RFTYPE:
            os << "T_RFTYPE";
            break;
